...
lst_of_names = sorted(lst_of_names)[475:1991]


for file_name in lst_of_names:
    image = Image.open(os.path.join(way_to_images, file_name))
    ...
    image_from_array.save(os.path.join(way_to_sample, file_name))
    image.close()
