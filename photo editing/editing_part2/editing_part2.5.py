...
way_to_images = way = r"C:\Users\Lenovo\Desktop\UIR\Void microCT dataset_Mehdikhani et al\Voids microCT dataset\Tomographic images\[67.5,22.5]2s"
lst_of_names = os.listdir(way_to_images)
lst_of_names = lst_of_names[118: 2057]
